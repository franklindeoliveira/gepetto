...
<html lang="en">
<head>
    <title>Artes de Madeira | Gepetto Marcenaria</title>
    ...
    <main>
        <section class="oficinas">
            ...
            <figure class="painel">
                ...
                <p>Proposta para resgatar a importância do brincar para bebês e suas famílias, com músicas, contação
                    de histórias e brinquedos simples e criativos.</a><br /><br />

                <p>Faça sua inscrição enviando um email para lacosdeencantamento@gmail.com anexando comprovante de pagamento.<br /><br />
                <p>Mensalidade: R$ 200,00 ou negociável por "troca de serviços"*.<br />
                Banco do Brasil<br />
                Ag 3560-2<br />
                Cc 16389-9<br />
                Em nome de Lucila Faleiros Neves<br />
                CPF 048.152.738-98</p><br /><br />
                <p>* troca de serviços: oferecido para famílias que embora não tenham condições financeiras no momento,
                    podem compartilhar suas habilidades pessoais. Por exemplo, se você tem habilidade de 
